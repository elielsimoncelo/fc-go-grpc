...
type CategoryServiceClient interface {
	...
	ListCategories(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*CategoryListResponse, error)
...
func (c *categoryServiceClient) ListCategories(ctx context.Context, in *EmptyRequest, opts ...grpc.CallOption) (*CategoryListResponse, error) {
...
type CategoryService_CreateCategoryStreamClient interface {
	...
	CloseAndRecv() (*CategoryListResponse, error)
	grpc.ClientStream
}
...
func (x *categoryServiceCreateCategoryStreamClient) CloseAndRecv() (*CategoryListResponse, error) {
	if err := x.ClientStream.CloseSend(); err != nil {
		return nil, err
	}
	m := new(CategoryListResponse)
...
type CategoryServiceServer interface {
	...
	ListCategories(context.Context, *EmptyRequest) (*CategoryListResponse, error)
...
func (UnimplementedCategoryServiceServer) ListCategories(context.Context, *EmptyRequest) (*CategoryListResponse, error) {
...
func _CategoryService_ListCategories_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	...
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CategoryServiceServer).ListCategories(ctx, req.(*EmptyRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
type CategoryService_CreateCategoryStreamServer interface {
	SendAndClose(*CategoryListResponse) error
...
func (x *categoryServiceCreateCategoryStreamServer) SendAndClose(m *CategoryListResponse) error {
